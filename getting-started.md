...
Step 5
{: .label .label-step}
Go ahead and create all the other passages for your story, by copy and pasting the text into passages as you just did above.  You can preview your story at any time by clicking the Build tab then clicking the Play button.
{: .step}

Step 6
{: .label .label-step}
Next please insert an image into one of your passages by typing or pasting the following HTML into the passage. If you would like to use your own image, paste the URL of your own image in place of the URL below between the quotation marks: 
```
<img src="https://i0.wp.com/richmccue.com/wp-content/uploads/2016/12/goats-looking-up.jpg" width="500">
```
...
Step 7
{: .label .label-step}
Experiment with different text types of formatting in a passage. 
...
Step 8
{: .label .label-step}
Rename one of the links (inside the double square brackets) in your first passage and see what happens.  
    - How can you fix it?
...
Step 9
{: .label .label-step}
Change the background colour, font type and font colour of your story by clicking on the Story tab and then clicking on Stylesheet.<br>  
	<img src="images/twine-intro-08b.png" style="float:right;height:100px" alt="Edit Storysheet button"><br> Now type in the following code:
```
tw-passage {
	font-family: arial;
  	color: black;
...
Step 11
{: .label .label-step}
To make your story and personal images publicly available on the internet, please follow the directions on our [Publish Your Twine Story on the Web Using GitHub Pages](github.html) activity.
...
Step 12
{: .label .label-step}
**Extra Credit Activities (if you have time)**:<br> Put URL links to other webpages or web resources into your story. E.g. ```<a href="http://google.com">Link text here.</a>```
{: .step}
...
Step 14
{: .label .label-step}
To make your “display text” different from the name of the passage you want to link to, use this format for your link: ```[[Display Text|Text of passage title]]```  **Note: Make sure there are no extra spaces, and the case is identical for the passage title. **
{: .step}

Step 15
{: .label .label-step}
Embed a YouTube video into one of your passages. **Note in the code below how you need to modify the YouTube URL for this work by deleting the “watch?v=” from the URL and replacing it with “embed/” :**
...
Step 16
{: .label .label-step}
Add a coin flip or other random event to one of your passages so that the story branches to one of two different passages depending on the coin flip for example. Note: you can have more than two items for your random event.```(either:"[[heads]]","[[tails]]","[[The coin falls into the storm drain]]")```
{: .step}

Step 17
{: .label .label-step}
Play some background audio in one of your passages:
```<audio autoplay loop>```
