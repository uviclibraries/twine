...
1. Signup for a GitHub Account (if you’d like you can watch this narrated video on YouTube of the [GitHub account creation process](https://youtu.be/ovCRBERA1NQ){:target="_blank"}):
 ...
 {% comment %} <button onclick="toggle('gif1')">Show / Hide Animation </button>
...
{% comment %}  <button onclick="toggle('gif2')">Show / Hide Animation </button> <div id="gif2"><img src="images/github-create-repository.gif" alt="GitHub Create Repository animated gif"></div> <br> {% endcomment %}
...
3. Upload your first Twine story or other files (if you’d like you can watch this narrated video of how to [upload your Twine story to GitHub](https://youtu.be/0FHgslaQnF4){:target="_blank"}: 
  ...
  {% comment %} <button onclick="toggle('gif3')">Show / Hide Animation </button><div id="gif3"><img src="images/github-upload-file.gif" alt="GitHub Upload File animated gif"></div> {% endcomment %}
